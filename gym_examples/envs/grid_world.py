...
class GridWorldEnv(gym.Env):
    ...
    def reset(self, seed=None, options=None):
        ...
        self._target_locations = self.get_target_locations()
        
        random_element = random.randint(0, len(self._target_locations) - 1)
        self._agent_location = self._target_locations[random_element]        
        del self._target_locations[random_element]
    ...
    def game_over_check(self):
        ...
        if self.steps_counter > 50 or self.iterations > 150:
            game_over = True
            reward = -100
        ...
        return reward - self.steps_counter - self.iterations, game_over, self.steps_counter # score is less with each step, hence 30 / steps_counter
    ...
    def _get_obs(self):
        return {"agent": self._agent_location, "target": self.matrix.flatten()}
